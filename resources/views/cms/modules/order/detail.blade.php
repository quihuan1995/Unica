...
<section class="invoice">
    ...
    <div class="row no-print">
        <div class="col-xs-12">
            ...
            <a href="order/{{$order->id}}/chancedisband" type="button" class="btn btn-danger pull-right">Hủy Đơn</a>
            <a href="order/{{$order->id}}/chancesuccess" type="button" class="btn btn-primary pull-right"><i class="fa fa-credit-card"></i>Active</a>
        </div>
    </div>
</section>
@endsection
